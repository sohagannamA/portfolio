    ...
    >
      <div className="w-full md:w-[80%] my-0 mx-auto">
        ...
        <div className="mt-10 flex items-center space-x-3">
          <div className="resfont_side_project_tect px-[10px] bg-gray-200 hover:bg-gray-300  py-[5px] dark:bg-[rgb(26,35,39)] dark:hover:bg-[rgb(38,50,56)] dark:text-gray-200 rounded cursor-pointer">
            Frontend
          </div>
          <div className="resfont_side_project_tect px-[10px] bg-gray-200 hover:bg-gray-300  py-[5px] dark:bg-[rgb(26,35,39)] dark:hover:bg-[rgb(38,50,56)] dark:text-gray-200 rounded cursor-pointer">
            Full Stack
