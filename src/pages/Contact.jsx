              ...
              <form>
                <div>
                  <input
                    ...
                    required
                    className="mb-5 w-full bg-gray-200  dark:bg-[rgb(26,35,39)] px-[10px] py-[8px] rounded dark:text-gray-300 outline-0"
                  />
                </div>
                <div>
                  <input
                ...
                <div>
                  <textarea
                    className="mb-5 bg-gray-200 dark:bg-[rgb(26,35,39)] px-[10px] py-[8px] rounded dark:text-gray-300 outline-0 w-full resize-none"
                    required
                  />
                </div>
